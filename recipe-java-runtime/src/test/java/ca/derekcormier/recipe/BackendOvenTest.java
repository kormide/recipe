...
public class BackendOvenTest {
  ...
  public void testBake_bakesRepeatedIngredient() {
    ...
    oven.registerHook(hook);
    oven.bake(
        "{\"recipe\":{\"Recipe\":{\"ingredients\":[{\"EmptyIngredient\":{}},{\"EmptyIngredient\":{}}]}}}");
  ...
  public void testBake_basedMultipleIngredients() {
    ...
    oven.bake(
        "{\"recipe\":{\"Recipe\":{\"ingredients\":[{\"EmptyIngredient\":{}},{\"IngredientWithRequired\":{}}]}}}");
  ...
  public void testBake_bakesIngredientInRecipeWithContext() {
    ...
    oven.bake(
        "{\"recipe\":{\"Recipe\":{\"context\":\"foo\",\"ingredients\":[{\"EmptyIngredient\":{}}]}},\"cake\":{}}");
  ...
  public static class IngredientWithRequiredHook
      extends BaseIngredientHook<IngredientWithRequiredData> {
