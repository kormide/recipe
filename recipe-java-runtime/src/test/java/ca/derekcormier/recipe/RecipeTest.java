...
public class RecipeTest {
    ...
    public void testContext_flattensInnerRecipeWithNoContext() {
        Ingredient ingredient = new Ingredient("TestIngredient", "A") {};
        Recipe recipe = Recipe.context("key",
            Recipe.prepare(ingredient)
        );
    ...
    public void testContext_preservesStructureOfInnerContextfulRecipe() {
        Ingredient ingredient = new Ingredient("TestIngredient", "A") {};
        Recipe recipe = Recipe.context("key",
            Recipe.context("key2", ingredient)
        );
    ...
    @Test
    public void testContext_contextIngredient_createsRecipeWithContextIngredientAndSubRecipeWithContext() {
    ...
    public void testContext_contextIngredient_flattensInnerRecipeWithNoContext() {
        ...
        Recipe recipe = Recipe.context(contextIngredient,
            Recipe.prepare(ingredient)
        );
    ...
    public void testContext_contextIngredient_preservesStructureOfInnerContextfulRecipe() {
        ...
        assertEquals("key", ((Recipe)recipe.getIngredients().get(1)).getContext());
        assertEquals(1, ((Recipe)recipe.getIngredients().get(1)).getIngredients().size());
        assertEquals("key2", ((Recipe)((Recipe)recipe.getIngredients().get(1)).getIngredients().get(0)).getContext());
        assertEquals(1, ((Recipe)((Recipe)recipe.getIngredients().get(1)).getIngredients().get(0)).getIngredients().size());
        assertEquals(ingredient, ((Recipe)((Recipe)recipe.getIngredients().get(1)).getIngredients().get(0)).getIngredients().get(0));
    }
    ...
    public void testSegment_contextIngredientAndSubIngredientInDifferentDomain() {
        ...
        assertEquals("A", segments.get(0).domain);
        assertEquals(1, segments.get(0).recipe.getIngredients().size());
        assertEquals("KeyedIngredient", segments.get(0).recipe.getIngredients().get(0).getIngredientType());
        assertEquals("B", segments.get(1).domain);
        assertEquals(1, segments.get(1).recipe.getIngredients().size());
        ...
        assertEquals("TestIngredient", ((Recipe)segments.get(1).recipe.getIngredients().get(0)).getIngredients().get(0).getIngredientType());
    }
    ...
    public void testSegment_multipleNestedContexts() {
        ...
        Recipe recipe = Recipe.context("key1",
            ingredient1,
            Recipe.context("key2",
                ingredient2
            )
        ...
        assertEquals(1, ((Recipe)segments.get(0).recipe.getIngredients().get(1)).getIngredients().size());
        assertEquals("TestIngredient2", ((Recipe)segments.get(0).recipe.getIngredients().get(1)).getIngredients().get(0).getIngredientType());
    }
    ...
    public void testSegment_nestedContextIngredientRecipeWithDifferentDomain() {
        ...
        assertEquals(1, segments.get(1).recipe.getIngredients().size());
        assertEquals("KeyedIngredient", segments.get(1).recipe.getIngredients().get(0).getIngredientType());
        ...
        assertEquals(1, ((Recipe)segments.get(2).recipe.getIngredients().get(0)).getIngredients().size());
        assertEquals("TestIngredient2", ((Recipe)segments.get(2).recipe.getIngredients().get(0)).getIngredients().get(0).getIngredientType());
    }
}