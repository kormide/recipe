...
public class TsValueFilterTest {
    ...
    public void testApply_throwsOnMissingTypeParam() {
        ...
        Filter filter = new TsValueFilter(cookbook);
    ...
    public void testApply_convertsArrayOfStrings() {
        ...
        assertEquals("[\"a\", \"b\", \"c\"]", filter.apply(Lists.newArrayList("a", "b", "c"), "string[]"));
    }
    ...
    public void testApply_convertsArrayOfEnums() {
        ...
        assertEquals("[MyEnum.A, MyEnum.B, MyEnum.C]", filter.apply(Lists.newArrayList("A", "B", "C"), "MyEnum[]"));
    }
    ...
    public void testApply_convertsVarargOfArraysOfStrings() {
        ...
        assertEquals("[[\"a\"], [\"b\", \"c\"]]", filter.apply(Lists.newArrayList(Lists.newArrayList("a"), Lists.newArrayList("b", "c")), "string[]..."));
    }
}
