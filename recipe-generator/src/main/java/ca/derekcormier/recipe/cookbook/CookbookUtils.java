...
public class CookbookUtils {
  ...
  public static boolean isKnownType(Cookbook cookbook, String type) {
    return CookbookUtils.isPrimitiveType(type)
        || CookbookUtils.isFlagType(type)
        || CookbookUtils.isEnumType(cookbook, type);
  }
  ...
  public static boolean isPrimitiveType(Type type) {
    return type instanceof PrimitiveType
        || type instanceof ArrayType && isPrimitiveType(((ArrayType) type).getBaseType());
  }
