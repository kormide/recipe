...
public class JavaIngredientTest {
  ...
  public void testGeneration_ingredientWithOptional() {
    new IngredientWithOptional().withOptional(true);
  }

  @Test
  public void testGeneration_ingredientWithRepeatableOptional() {
    new IngredientWithRepeatableOptional().withOptional(true).withOptional(false);
  }

  @Test
  public void testGeneration_ingredientWithRepeatableVarargOptional() {
    new IngredientWithRepeatableVarargOptional().withOptional(1, 2).withOptional(3, 4);
  }
  ...
  public void testGeneration_ingredientWithRequiredAndOptional() {
    new IngredientWithRequiredAndOptional("foo").withOptional(false);
  }
  ...
  public void testGeneration_booleanType() {
    new AllParamsIngredient().withBooleanArg(true);
  }
  ...
  public void testGeneration_floatType() {
    new AllParamsIngredient().withFloatArg(1.123f);
  }
  ...
  public void testGeneration_enumType() {
    new AllParamsIngredient().withEnumArg(TestEnum.B);
  }

  @Test
  public void testGeneration_primitiveArrayType() {
    new AllParamsIngredient().withStringArrayArg(new String[] {"foo", "bar"});
  }

  @Test
  public void testGeneration_enumArrayType() {
    new AllParamsIngredient().withEnumArrayArg(new TestEnum[] {TestEnum.A, TestEnum.C});
  }

  @Test
  public void testGeneration_varargType() {
    new AllParamsIngredient().withVarargArg("foo", "bar");
  }

  @Test
  public void testGeneration_varargArrayType() {
    new AllParamsIngredient().withVarargArrayArg(new int[] {1, 2}, new int[] {3, 4});
  }

  @Test
  public void testGeneration_compoundOptional() {
    new IngredientWithCompoundOptional().withCompoundOptional(5, true);
  }

  @Test
  public void testGeneration_compoundOptionalWithOneParam() {
    new IngredientWithCompoundOptionalWithOneParam().withCompoundOptional(3);
  }
  ...
  public void testGeneration_ingredientWithJavaKeywords() {
    new IngredientWithJavaKeywords(true).withBoolean(false).withClass(5).withPackage(2, "foo");
  }
  ...
  public void testGeneration_compoundOptionalReturnsInstanceOfSameType() {
    assertTrue(
        new IngredientWithCompoundOptional().withCompoundOptional(0, false)
            instanceof IngredientWithCompoundOptional);
  }
  ...
  public void testBake_serialization_ingredientWithDefaultRequired() {
    ...
    assertDispatchedJson(
        payloadJson(
            "{\"IngredientWithDefaultRequired\":{\"param1\":\"foobar\",\"param2\":false,\"param3\":\"A\"}}"));
  }
  ...
  public void testBake_serialization_ingredientWithDefaultRequiredNoInitializers() {
    ...
    assertDispatchedJson(
        payloadJson("{\"IngredientWithDefaultRequiredNoInitializers\":{\"required\":5}}"));
  }
  ...
  public void testBake_serialization_ingredientWithRepeatableCompoundOptional() {
    ...
    assertDispatchedJson(
        payloadJson(
            "{\"IngredientWithRepeatableCompoundOptional\":{\"compoundOptional\":[{\"param1\":5,\"param2\":false},{\"param1\":-2,\"param2\":true}]}}"));
  }
  ...
  public void testBake_serialization_ingredientWithCompoundOptionalWithOneParam() {
    setupDispatcherSpy("TestDomain");
    oven.bake(
        Recipe.prepare(new IngredientWithCompoundOptionalWithOneParam().withCompoundOptional(3)));

    assertDispatchedJson(
        payloadJson(
            "{\"IngredientWithCompoundOptionalWithOneParam\":{\"compoundOptional\":{\"param1\":3}}}"));
  }
  ...
  public void testBake_serialization_ingredientWithStringDefaultContainingQuotes() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new IngredientWithStringDefaultContainingQuotes()));
  ...
  public void testBake_serialization_ingredientWithRequiredVararg() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new IngredientWithRequiredVararg("foo", "bar")));

    assertDispatchedJson(
        payloadJson("{\"IngredientWithRequiredVararg\":{\"required\":[\"foo\",\"bar\"]}}"));
  }

  @Test
  public void testBake_serialization_ingredientWithRequiredAndRequiredVararg() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new IngredientWithRequiredAndRequiredVararg(5)));
  ...
  public void testBake_serialization_ingredientWithRequiredStringArrayWithDefault() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new IngredientWithRequiredStringArrayWithDefault()));
  ...
  public void testBake_serialization_ingredientWithRequiredVarargStringArrayWithDefault() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new IngredientWithRequiredVarargStringArrayWithDefault()));
  ...
  public void testBake_serialization_keyedIngredientWithDefaultKey() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new KeyedIngredientWithDefaultKey("foo")));

    assertDispatchedJson(
        payloadJson("{\"KeyedIngredientWithDefaultKey\":{\"key\": \"foo\",\"required\":\"foo\"}}"));
  }

  @Test
  public void testBake_serialization_keyedIngredientWithDefaultKeyParamIsDefaulted() {
    setupDispatcherSpy("TestDomain");
    oven.bake(Recipe.prepare(new KeyedIngredientWithDefaultKeyParamIsDefaulted()));
  ...
  public void testBake_serialization_recipeWithContextAndChildIngredient() {
    ...
    oven.bake(Recipe.context("foo", new EmptyIngredient()));
  ...
  public void testBake_serialization_recipeWithUnkeyedContextIngredient() {
    ...
    assertDispatchedJson(
        "{\"recipe\":{\"Recipe\":{\"ingredients\":[{\"KeyedTestIngredient\":{}}]}},\"cake\":{}}");
  }
  ...
  public void testBake_serialization_recipeWithKeyedContextIngredient() {
    ...
    assertDispatchedJson(
        "{\"recipe\":{\"Recipe\":{\"ingredients\":[{\"KeyedTestIngredient\":{\"key\":\"foo\"}}]}},\"cake\":{}}");
  }
  ...
  public void testBake_serialization_recipeContextIngredientAndChild() {
    ...
    oven.bake(Recipe.context(new KeyedTestIngredient().keyed("foo"), new EmptyIngredient()));

    assertDispatchedJson(
        "{\"recipe\":{\"Recipe\":{\"ingredients\":[{\"KeyedTestIngredient\":{\"key\":\"foo\"}},{\"Recipe\":{\"context\":\"foo\",\"ingredients\":[{\"EmptyIngredient\":{}}]}}]}},\"cake\":{}}");
  }
  ...
  public void testBake_deserializesCake() {
    ...
    Cake cake = oven.bake(Recipe.prepare(new EmptyIngredient()));
  ...
  public void testBake_propagatesCakeUpdatesToSubsequentDispatches() {
    ...
    Cake cake = oven.bake(Recipe.prepare(new EmptyIngredient(), new DomainBIngredient()));

    verify(dispatcherSpy).dispatch(eq(payloadJson("{\"EmptyIngredient\":{}}")));
    verify(dispatcherSpyB)
        .dispatch(
            eq(payloadJsonWithCake("{\"someKey\":\"someValue\"}", "{\"DomainBIngredient\":{}}")));
