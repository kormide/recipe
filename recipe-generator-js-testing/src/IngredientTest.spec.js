...
const { EmptyIngredient, IngredientWithOptional, IngredientWithDefaultRequired, IngredientWithRequired, TestEnum, IngredientWithRepeatableOptional, IngredientWithRepeatableVarargOptional, IngredientWithRequiredAndOptional, AllParamsIngredient, IngredientWithCompoundOptional, IngredientWithRepeatableCompoundOptional, IngredientWithCompoundOptionalWithOneParam, IngredientWithDefaultRequiredNoInitializers, IngredientWithMultipleInitializersWithEnumAndStringInSamePosition, IngredientWithStringDefaultContainingQuotes, IngredientWithNullStringDefault, IngredientWithConstant, KeyedIngredientWithDefaultKey, KeyedIngredientWithDefaultKeyParamIsDefaulted, IngredientWithRequiredVararg, IngredientWithRequiredStringArrayWithDefault, IngredientWithRequiredVarargStringArrayWithDefault, IngredientWithRequiredAndRequiredVararg, IngredientWithJavaScriptKeywords } = require("../target/ingredients");
const { PostfixIngredientFoo } = require ("../target/ingredients/postfix");
...
describe("generation", () => {
    ...
    it("should generate and ingredient with javascript keywords", () => {
        new IngredientWithJavaScriptKeywords(true)
            .withUndefined(5)
            .withTry(true)
            .withThis(5, "foobar");
    });
...
function expectJsonEquals(expected, actual) {
